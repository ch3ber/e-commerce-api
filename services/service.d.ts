...
/**
 * Extends the find method in SearchableService
 * to add pagination
 * @interface
 * @extends SearchableService
 * @method
 * @name Pagination
 */
export interface Pagination {
  find: (query: qs.ParsedQs) => Promise<Model[]>
}
 ...
 */
export class MakeBaseServiceFrom implements CreateableService, SearchableService, UpgradableService, DeletableService, Pagination {
